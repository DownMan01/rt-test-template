    ...
    <div className="min-h-screen bg-[#15202B] text-white p-4 sm:p-6">
      <div className="max-w-2xl mx-auto space-y-6 sm:space-y-8">
        ...
        >
          ...
          >
            {/* Tweet container - Properly scaled desktop-like proportions for mobile */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-full max-w-md sm:max-w-lg bg-[#151f2b] px-6 sm:px-12">
                {/* Profile section - Readable but scaled for mobile */}
                <div className="flex items-start">
                  ...
                  <div className="flex-grow min-w-0">
                    <div className="text-white font-bold text-base sm:text-xl truncate">{name}</div>
                    <div className="text-gray-500 text-base sm:text-xl truncate">@{handle}</div>
                  </div>
                  <div className="text-gray-500 text-sm leading-none flex-shrink-0 ml-2">•••</div>
                </div>

                {/* Tweet content - Readable size that scales nicely */}
